from egg_rally.egg_entities import Egg, EggConfig
...
class TestEgg:
    def test_egg_creation(self):
        ...
        assert egg._damage_hitbox == Hitbox(
            new_reference_point, new_width_height_vector.x_hat, new_width_height_vector.y_hat)
    ...
    def test_egg_deal_damage(self):
        ...
        egg_config_attacker = EggConfig(hitbox=egghitbox,
                                        ...
                                        damage_hitbox_scale=1.0,
                                        invincibility_frames=30)
        attacker_egg = Egg(egg_config_attacker, 3)
        ...
        target_egg = Egg(egg_config_target, 3)
