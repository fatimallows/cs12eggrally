...
import { Cmd, startModelCmd } from "../../node_modules/cs12242-mvu/src/index"
import { CanvasMsg, canvasView } from "../../node_modules/cs12242-mvu/src/canvas"
import * as Canvas from "../../node_modules/cs12242-mvu/src/canvas"
...
const update = (msg: Msg, model: Model): Model | { model: Model, cmd: Cmd<Msg> } =>
  Match.value(msg).pipe(
    Match.tag("Canvas.MsgTick", () => {
      ...
      newModel = {
        ...newModel
        eggnemies: newModel.eggnemies.map((e) => {
